...
static void Os_1000ms_Task(void);
...
void Os_Task_Counter_Handler(void)
{
	...
	if(Os_Var.Os_Counter.Os_1ms_Counter % 5 == 0)
	{
		Os_Var.Os_Counter.Os_5ms_Counter++;
		Os_Var.Os_Task_Flag.Os_5ms_Flag = 1;
	}
	if(Os_Var.Os_Counter.Os_1ms_Counter % 10 == 0)
	{
	...
	if(Os_Var.Os_Counter.Os_1ms_Counter % 1000 == 0)
	{
		Os_Var.Os_Counter.Os_1000ms_Counter++;
		Os_Var.Os_Task_Flag.Os_1000ms_Flag = 1;
	}
}
...
void Os_Handler(void)
{
	...
	else if(Os_Var.Os_Task_Flag.Os_5ms_Flag == 1)
	{
		fp = Os_5ms_Task;
	...
	else if(Os_Var.Os_Task_Flag.Os_10ms_Flag == 1)
	{
		fp = Os_10ms_Task;
	...
	else if(Os_Var.Os_Task_Flag.Os_100ms_Flag == 1)
	{
		fp = Os_100ms_Task;
	...
	else if(Os_Var.Os_Task_Flag.Os_1000ms_Flag == 1)
	{
		fp = Os_1000ms_Task;
		Os_Var.Os_Task_Add.Os_1000ms_Address = fp;
		Os_Var.Os_Task_Flag.Os_1000ms_Flag = 0;
		Os_Calc_Runtime_Start(OS_TASK_INDEX_1000MS);
		(void)Os_1000ms_Task();
		Os_Calc_Runtime_Stop(OS_TASK_INDEX_1000MS);
		Os_Calc_Period(OS_TASK_INDEX_1000MS);
	}
	else
	{
...
static void Os_Calc_Period(uint8 idx)
{
	...
	switch(idx)
	{
		...
		break;
		case OS_TASK_INDEX_1000MS : 
			OS_TimeOldLoc = Os_Var.Os_Tick_Period.Os_1000ms_Tick_Period;
		break;
	}
	...
	switch(idx)
	{
		...
		break;
		case OS_TASK_INDEX_1000MS : 
			Os_Var.Os_Period.Os_1000ms_Period = Os_TimeDiffLoc;
			Os_Var.Os_Tick_Period.Os_1000ms_Tick_Period = OS_TimeOldLoc;
		break;
	}
...
static void Os_Calc_Runtime_Start(uint8 idx)
{
	...
	switch(idx)
	{
		...
		break;
		case OS_TASK_INDEX_1000MS :
			Os_Var.Os_Tick_Runtime.Os_1000ms_Tick_Runtime_Start = OS_TimeLoc;
		break;
	}
...
static void Os_Calc_Runtime_Stop(uint8 idx)
{
	...
	switch(idx)
	{
		...
		break;
		case OS_TASK_INDEX_1000MS :
			OS_TimeOldLoc = Os_Var.Os_Tick_Runtime.Os_1000ms_Tick_Runtime_Start;
		break;
	}
	...
	switch(idx)
	{
		...
		break;
		case OS_TASK_INDEX_1000MS :
			Os_Var.Os_Runtime.Os_1000ms_Runtime = Os_TimeDiffLoc;
			Os_Var.Os_Tick_Runtime.Os_1000ms_Tick_Runtime_Stop = OS_TimeLoc;
		break;
	}
